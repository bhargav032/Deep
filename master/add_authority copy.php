												...
												<div class="col-xl-8">
													<div class="kt-section kt-section--first">
														<div class="kt-section__body">
															...
															<div class="form-group row">
																<label class="col-3 col-form-label">Contact
																	Phone</label>
																<div class="col-9">
													...
													<div class="kt-section">
														<div class="kt-section__body">
															<h3 class="kt-section__title kt-section__title-lg">Address
																Details:</h3>
															<div class="form-group row">
															...
															<div class="form-group row">
																<label class="col-3 col-form-label">Address Line
																	1</label>
																<div class="col-9">
																	<input class="form-control" type="text"
															...
															<div class="form-group row">
																<label class="col-3 col-form-label">State / Province /
																	Region</label>
																<div class="col-9">
																	<input class="form-control" type="text"
																		value="Los Angeles">
															...
															<div class="form-group row">
																<label class="col-3 col-form-label">Zip / Postal
																	Code</label>
																<div class="col-9">
																	<input class="form-control" type="text"
																		value="780456">
																...
																<div class="col-9">
																	<div class="kt-checkbox-single">
																		<label class="kt-checkbox">
																			<input type="checkbox"> Use as shipping
																			address.
																			<span></span>
																		</label>
																	</div>
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<select class="form-control">
																		...
																		<option data-offset="-18000"
																			value="Guadalajara">(GMT-05:00) Guadalajara
																		</option>
																		<option data-offset="-18000"
																			value="Mexico City">(GMT-05:00) Mexico City
																		</option>
																		...
																		<option data-offset="-14400"
																			value="Indiana (East)">(GMT-04:00) Indiana
																			(East)</option>
																		...
																		<option data-offset="43200"
																			value="Marshall Is.">(GMT+12:00) Marshall
																			Is.</option>
													...
													<div class="kt-section kt-section--last">
														<div class="kt-section__body">
															<h3 class="kt-section__title kt-section__title-lg">Security:
															</h3>
															<div class="form-group row">
																<label class="col-3 col-form-label">Login
																	verification</label>
																<div class="col-9">
																	<button type="button"
															...
															<div class="form-group row">
																<label class="col-3 col-form-label">Password reset
																	verification</label>
																<div class="col-9">
																	<div class="kt-checkbox-single">
																		<label class="kt-checkbox">
