			...
			<div class="kt-portlet" id="kt_page_portlet">
				<div class="kt-portlet__head kt-portlet__head--lg">
					...
					<div class="kt-portlet__head-toolbar">
						<a href="brand_edit.php?id=<?php echo $id ?>" class="btn btn-secondary kt-margin-r-10">
								...
								<div class="kt-section__body">
									...
									<form class="kt-form" method="post" action="brand_view.php">
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Authority Type" name="name" value=<?php echo $brand; ?> disabled>
											</div>
