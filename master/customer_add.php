			...
			<div class="kt-portlet" id="kt_page_portlet">
				...
				<div class="kt-portlet__head kt-portlet__head--lg">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Add Customer</h3>
						<h3 class="kt-portlet__head-title">
							...
							if (isset($_POST['Submit'])) {
								...
								echo "Customer added successfully. <a href='index.php'>View Users</a>";
							}
							?>
						</h3>
					</div>
					...
					<div class="kt-portlet__head-toolbar">
						<a href="customer_list.php" class="btn btn-secondary kt-margin-r-10">
						...
						<div class="col-xl-8">
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<form class="kt-form" method="post" action="customer_add.php">
