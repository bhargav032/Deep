...
if (isset($_POST['update'])) {
    ...
    // update user data
    $sql = "UPDATE mst_customer SET name='$name', brand='$brand', version='$version' WHERE id=$id";
                                ...
                                <div class="kt-section__body">
                                    ...
                                    <form class="kt-form" method="post" action="view.php?id=<?php echo $id ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control" type="text" placeholder="Model" name="model" value=<?php echo $name; ?> <?php echo $page_property; ?>>
                                            </div>
                                        </div>
                                        <div class="form-group row">
