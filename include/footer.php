...
<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__copyright">
                            2018&nbsp;&copy;&nbsp;<a href="http://hexits.com" target="_blank" class="kt-link">TPP</a>
                        </div>
                        <div class="kt-footer__menu">
                            <a href="http://hexits.com" target="_blank" class="kt-footer__menu-link kt-link">About</a>
                            <a href="http://hexits.com" target="_blank" class="kt-footer__menu-link kt-link">Team</a>
                            <a href="http://hexits.com" target="_blank" class="kt-footer__menu-link kt-link">Contact</a>
                        </div>
                    </div>
                </div>
                <!-- end:: Footer -->
    ...
    <ul class="kt-sticky-toolbar" style="margin-top: 30px;">
        ...
        <li class="kt-sticky-toolbar__item kt-sticky-toolbar__item--docs" data-toggle="kt-tooltip" title="Documentation" data-placement="left">
            <a href="../../../../keenthemes.com/keen/indexfa01.html?page=docs" target="_blank"><i class="flaticon2-file"></i></a>
        </li>
    </ul>
    <!-- end:: Demo Toolbar -->
	...
	<script src="<?php echo BASE_URL ?>assets/plugins/custom/datatables/datatables.bundle.js"
		type="text/javascript"></script>
	<!--end::Page Vendors -->

	<!--begin::Page Scripts(used by this page) -->
	<script src="<?php echo BASE_URL ?>assets/js/pages/components/datatables/extensions/buttons.js"
		type="text/javascript"></script>
	<!--end::Page Scripts -->

    <!--begin::Page Scripts(used by this page) -->
	<script src="<?php echo BASE_URL ?>assets/js/pages/components/forms/widgets/select2.js"
		type="text/javascript"></script>
	<!--end::Page Scripts -->

    <!--begin::Page Vendors(dashboard) -->
    <script src="<?php echo BASE_URL ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
    <!--end::Page Vendors -->

    <!--begin::Page Scripts(Dashboard) -->
