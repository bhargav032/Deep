                                ...
                                <div class="kt-section__body">
                                    ...
                                    <form class="kt-form" method="post" action="view.php?id=<?php echo $id ?>">                                        
                                        <div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Job ID" name="job_no"  <?php echo $page_property; ?> value=<?php echo $job_no; ?>>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="date" placeholder="Job Invert Date" name="date" <?php echo $page_property; ?> value=<?php echo $date; ?>>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Customer Name" name="customer_name" <?php echo $page_property; ?> value=<?php echo $customer_name; ?>>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Brand" name="brand"  <?php echo $page_property; ?> value=<?php echo $brand; ?>>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Model" name="model" <?php echo $page_property; ?> value=<?php echo $model; ?>>
											</div>
										</div>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Job Type" name="job_type" <?php echo $page_property; ?> value=<?php echo $job_type; ?>>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-9">
												<input class="form-control" type="text" placeholder="Complaint" name="complaint" <?php echo $page_property; ?> value=<?php echo $complaint; ?>>
											</div>
										</div>
