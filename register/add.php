					...
					<div class="kt-portlet__head-label">
						...
						<h3 class="kt-portlet__head-title">
							...
							if (isset($_POST['Submit'])) {
								...
								$result = mysqli_query($connection, "INSERT INTO register(job_no,date,customer_name,brand,model,job_type,complaint,status) VALUES('$job_no','$date','$customer_name','$brand','$model','$job_type','$complaint','PENDING')");
								...
								<div class="kt-section__body">
									...
									<form class="kt-form" method="post" action="add.php">
										...
										<div class="form-group row">
											...
											<div class=" col-lg-4 col-md-9 col-sm-12">
												<?php
												$result = mysqli_query($connection, "SELECT * FROM mst_job_type ORDER BY id");
												if (mysqli_num_rows($result) > 0) {
												?>
													<select class="form-control kt-select2" id="kt_select2_1" name="job_type">
