                            ...
                            <td><a href='view.php?id=<?php echo $row["id"] ?>'><?php echo $row["id"]; ?></a></td>
								...
								<td>
                                    <?php
                                        ...
                                        $data = mysqli_query($connection, "SELECT name FROM mst_customer WHERE id='{$customer_record}'");
								...
								<td>
                                    <?php
                                        ...
                                        $data = mysqli_query($connection, "SELECT job_type FROM mst_job_type WHERE id='{$job_type_id}'");
                                        $row_data = $data->fetch_assoc();
                                        echo $row_data["job_type"];
                                    ?>
                                </td>
